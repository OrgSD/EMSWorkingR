...
namespace EMS_IMD.Areas.Export.Controllers
{
    ...
    {
        NotifyPartyDAO primaryDAO = new NotifyPartyDAO();

        //
        // GET: /Export/NotifyParty/
        public ActionResult frmNotifyParty()
        {
        ...
        public ActionResult GetNotifyParty()
        {
            var data = primaryDAO.GetNotifyPartyList();
            return Json(data, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public ActionResult OperationsMode(NotifyPartyBEL master)
        {
            try
            {
        ...
        public ActionResult GetNotifyPartyByBuyer(string BuyerCode)
        {
            var data = primaryDAO.GetNotifyPartyByBuyer(BuyerCode);
            return Json(data, JsonRequestBehavior.AllowGet);
        }
	}
}
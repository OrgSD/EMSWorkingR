...
{
    public class ConsigneeInfoController : Controller
    {
        ConsigneeInfoDAO primaryDAO = new ConsigneeInfoDAO();

        //
        // GET: /Export/ConsigneeInfo/
        public ActionResult frmConsigneeInfo()
        {
        ...
        {
            var data = primaryDAO.GetConsigneeList();
            return Json(data, JsonRequestBehavior.AllowGet);
        }


        [AcceptVerbs(HttpVerbs.Post)]
        public ActionResult GetConsigneeByBuyer(string BuyerCode)
        {
            var data = primaryDAO.GetConsigneeByBuyer(BuyerCode);
            return Json(data, JsonRequestBehavior.AllowGet);
        }

        [HttpPost]
        public ActionResult OperationsMode(ConsigneeInfoBEL master)
        {
            try
            {
